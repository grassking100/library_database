<?php
	...
	{
		$sql = "SELECT b.book_id,book_name,publish_date,language,email,a.name as author_name,p.name as publisher_name ,a.email as author_email,p.phone_number as publisher_phone,p.address as publisher_address,a.phone_number as author_phone 
